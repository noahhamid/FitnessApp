    ...
    <View style={s.canvas}>
      ...
      <View style={s.form}>
        ...
        <View style={s.fieldGroup}>
          <View style={s.labelRow}>
            ...
            {onForgotPassword && (
              <Text style={s.forgotLink} onPress={onForgotPassword}>
                Forgot password?
              </Text>
            )}
          </View>
          <View
            style={[s.inputSurface, passwordFocused && s.inputSurfaceFocused]}
          >
            <TextInput
              style={s.input}
              value={password}
        ...
        >
          {isLoading ? (
            <View style={s.loadingRow}>
              ...
              <Text style={s.primaryBtnLabel}>SIGNING IN…</Text>
            </View>
          ) : (
      ...
      {onSignUp && (
        <Text style={s.footerText}>
          ...
          <Text style={s.footerLink} onPress={onSignUp}>
            Sign up
          </Text>
        </Text>
      )}
