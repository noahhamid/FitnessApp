...
export function SignInForm({ email, password, onChangeEmail, onChangePassword, onSubmit }: Props) {
  return (
    <View style={s.wrap}>
      <Text style={s.title}>SIGN IN</Text>
      <Input label="Email" value={email} onChangeText={onChangeEmail} placeholder="you@example.com" keyboardType="email-address" />
      <Input label="Password" value={password} onChangeText={onChangePassword} placeholder="••••••••" secureTextEntry />
