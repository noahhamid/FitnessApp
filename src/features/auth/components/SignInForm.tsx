...
export function SignInForm() {
  ...
  async function handleContinue() {
    ...
    try {
      ...
      // Route based on whether onboarding was already completed, rather
      // than always dumping returning users back into onboarding.
      ...
      try {
        ...
        // If this fails, fall through to onboarding rather than blocking sign-in.
      }
      ...
      >
        ...
        >
          ...
          <View style={s.formArea}>
            ...
            <Text style={s.sub}>
              UI only for now — no auth check happens yet.
            </Text>
