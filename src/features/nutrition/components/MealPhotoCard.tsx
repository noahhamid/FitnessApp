...
let manualMealUri: string | undefined;

function getManualMealUri(): string {
  if (manualMealUri === undefined) {
    manualMealUri = Image.resolveAssetSource(MANUAL_MEAL_ASSET).uri;
  }
  return manualMealUri;
}
