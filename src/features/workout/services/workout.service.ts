...
export const EXERCISES = [
  { id: "e1", name: "Bench Press", muscle: "Chest", icon: "dumbbell", tag: "Compound" },
  { id: "e2", name: "Incline DB Press", muscle: "Chest", icon: "dumbbell", tag: "Compound" },
  { id: "e3", name: "Cable Fly", muscle: "Chest", icon: "repeat", tag: "Isolation" },
  { id: "e4", name: "Push-Up", muscle: "Chest", icon: "move-up", tag: "Bodyweight" },
  { id: "e5", name: "Deadlift", muscle: "Back", icon: "dumbbell", tag: "Compound" },
  { id: "e6", name: "Pull-Up", muscle: "Back", icon: "move-up", tag: "Bodyweight" },
  { id: "e7", name: "Barbell Row", muscle: "Back", icon: "dumbbell", tag: "Compound" },
  { id: "e8", name: "Lat Pulldown", muscle: "Back", icon: "repeat", tag: "Machine" },
  { id: "e9", name: "OHP", muscle: "Shoulders", icon: "dumbbell", tag: "Compound" },
  { id: "e10", name: "Lateral Raise", muscle: "Shoulders", icon: "repeat", tag: "Isolation" },
  { id: "e11", name: "Face Pull", muscle: "Shoulders", icon: "repeat", tag: "Isolation" },
  { id: "e12", name: "Barbell Curl", muscle: "Arms", icon: "dumbbell", tag: "Isolation" },
  { id: "e13", name: "Tricep Pushdown", muscle: "Arms", icon: "repeat", tag: "Isolation" },
  { id: "e14", name: "Hammer Curl", muscle: "Arms", icon: "dumbbell", tag: "Isolation" },
  { id: "e15", name: "Squat", muscle: "Legs", icon: "dumbbell", tag: "Compound" },
  { id: "e16", name: "Romanian Deadlift", muscle: "Legs", icon: "dumbbell", tag: "Compound" },
  { id: "e17", name: "Leg Press", muscle: "Legs", icon: "repeat", tag: "Machine" },
  { id: "e18", name: "Lunges", muscle: "Legs", icon: "move-up", tag: "Compound" },
  { id: "e19", name: "Plank", muscle: "Core", icon: "move-up", tag: "Bodyweight" },
  { id: "e20", name: "Cable Crunch", muscle: "Core", icon: "repeat", tag: "Isolation" },
  { id: "e21", name: "Hanging Leg Raise", muscle: "Core", icon: "move-up", tag: "Bodyweight" },
  { id: "e22", name: "Treadmill Run", muscle: "Cardio", icon: "person-standing", tag: "Cardio" },
  { id: "e23", name: "Rowing Machine", muscle: "Cardio", icon: "activity", tag: "Cardio" },
  { id: "e24", name: "Jump Rope", muscle: "Cardio", icon: "activity", tag: "Cardio" },
];
...
export const WORKOUT_TEMPLATES = [
  { id: "t1", name: "PUSH DAY", tag: "Chest · Shoulders · Triceps", icon: "dumbbell" },
  { id: "t2", name: "PULL DAY", tag: "Back · Biceps", icon: "layers" },
  { id: "t3", name: "LEG DAY", tag: "Quads · Hamstrings · Glutes", icon: "person-standing" },
  { id: "t4", name: "FULL BODY", tag: "All Muscle Groups", icon: "zap" },
];
