      ...
      <Animated.View
        ...
        style={{
          ...
          transform: [
            ...
            { scale: Animated.multiply(iconScale, press) },
...
function FloatingTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  const indicatorOutputs = useMemo(
    () =>
      state.routes.map((_, i) => i * slotW + (slotW - indicatorW) / 2),
    [slotW, indicatorW, state.routes.length],
  );
...

                    {
                      ...
                      translateX: indexAnim.interpolate({
                        ...
                        outputRange: [
                          ...
                          indicatorOutputs[0] ?? 0,

                          indicatorOutputs[lastIndex] ?? 0,
